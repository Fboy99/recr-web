...
const JobSubscription = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-col max-w-[1040px] h-auto lg:flex-row p-6 rounded-[15px] shadow-lg space-y-6 lg:space-y-0 lg:space-x-6">
        ...
        <div className="lg:w-1/2 flex items-center">
          <Image
            ...
            width={500}
            height={300}
            className="rounded-lg w-full h-auto object-cover xs:hidden sm:hidden md:hidden"
          />
        </div>
      </div>
    </div>
