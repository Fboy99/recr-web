...
export default function Faq() {
  ...
  const [visibleCount, setVisibleCount] = useState({ Candidates: 8, Employers: 8 }); // Number of visible items per category
  ...
  const handleShowLess = () => {
    setVisibleCount(prevCount => ({
      ...prevCount,
      [selectedTab]: Math.max(prevCount[selectedTab] - 10, 8) // Ensure at least 8 are shown
    }));
  };
      ...
      <div className="flex my-4 ">
        <ToggleButton
          ...
          onClick={() => {
            ...
            setVisibleCount(prev => ({ ...prev, Candidates: 8 })); // Reset visible count when changing tab
          }}
          label="Candidates"
          isLeft={true}
        />
        <ToggleButton
          ...
          onClick={() => {
            ...
            setVisibleCount(prev => ({ ...prev, Employers: 8 })); // Reset visible count when changing tab
          }}
          label="Employers"
          isLeft={false}
        />
