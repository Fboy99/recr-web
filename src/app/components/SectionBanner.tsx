...
const SectionBanner: React.FC<SectionBannerProps> = ({ title, className }) => {
  return (
    <div className={`w-full h-[204px] md:h-[164px] sm:h-[124px] xs:h-[96px] px-[96px] xs:px-[24px] sm:px-[24px] md:px-[28px] py-[48px] sm:py-[40px]  flex items-center justify-center opacity-100 ${className}`}>
