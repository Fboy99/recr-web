...
export function Advantages() {
  return (
    <div className="w-full max-w-[1440px] mx-auto flex flex-col items-center gap-y-6">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-y-6 items-center lg:items-start">
  {/* Candidate Card */}
  <div className="w-full max-w-[496px] h-auto rounded-[28px] shadow-md flex flex-col justify-between mx-auto lg:mr-[-96px]"> {/* Negative margin for the right card */}
    <Image
      src={img1}
      alt="feature 1 image"
      width={496}
